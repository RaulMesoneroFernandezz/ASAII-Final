...
msg4:	.string "El contador solo puede contar hasta 9 como maximo.\n"
...
contador:
	...
	#-- Comprobar si el segundo numero es menor o igual que 10
	li t4, 10
	bgt t1, t4, error2
...
contar:
	...
	lw t2, 4(sp)  #-- Recuperamos de la pila el valor de t2
	lw t3, 0(sp)  #-- Recuperamos de la pila el valor de t3
